...
// This testing using with TestContainers - ensure your docker should be running in the system

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
//@Testcontainers -> It has to remove because we are manually managing container start() in the abstract class
public class EmployeeControllerITContainer extends AbstractionBaseContainerTest {
